            ...
            <div className="w-full xl:w-2/3">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="flex-1 flex gap-4 justify-between flex-wrap">
                        {/* CARD */}
                        <div className="bg-white p-4 rounded-md flex gap-4 2-full md:w-[48%] xl:w-[45%] 2x:w-[48%]">
                            <Image
                            ...
                            <div className="">
                                ...
                                <span className="text-sm text-gray-400">Vijushmeria</span>
                            </div>
                        </div>
                        {/* CARD */}
                        <div className="bg-white p-4 rounded-md flex gap-4 2-full md:w-[48%] xl:w-[45%] 2x:w-[48%]">
                            ...
                            <div className="">
                                ...
                                <span className="text-sm text-gray-400">Lëndët</span>
                            </div>
                        </div>
                        {/* CARD */}
                        <div className="bg-white p-4 rounded-md flex gap-4 2-full md:w-[48%] xl:w-[45%] 2x:w-[48%]">
                        ...
                        <div className="bg-white p-4 rounded-md flex gap-4 2-full md:w-[48%] xl:w-[45%] 2x:w-[48%]">
                            ...
                            <div className="">
                                ...
                                <span className="text-sm text-gray-400">Klasat</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        ...
                        >
                            Nxënësit e mësimdhënësit
                        </Link>
                        <Link
                            className="p-3 rounded-md bg-lamaYellowLight"
                            href={`/list/lessons?teacherId=${teacher.id}`}
                        >
                            Orët mësimore të mësimdhënësit
                        </Link>
                        <Link
                            className="p-3 rounded-md bg-pink-50"
                            href={`/list/exams?teacherId=${teacher.id}`}
                        >
                            Provimet e mësimdhënësit
                        </Link>
                        <Link
                            className="p-3 rounded-md bg-lamaSkyLight"
                            href={`/list/assignments?teacherId=${teacher.id}`}
                        >
                            Detyrat e mësimdhënësit
                        </Link>
                    </div>
                </div>
                {/* <Performance /> */}
